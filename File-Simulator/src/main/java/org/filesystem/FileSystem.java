...
public class FileSystem
{
   ...
   * @exception IOException if any IOExceptions are thrown
   * during the open.
   */
   ...
   * @exception IOException if the open or read causes
   ...
   * @exception IOException if the closing the backing
   ...
   * @exception IOException if there are any exceptions during
   ...
   * @exception IOException if any exception occurs during an
   ...
   * @exception IOException if there is an exception during
