...
public class FileSystem {
   ...
   * @throws IOException if any IOExceptions are thrown
   *                     during the open.
   */
   ...
   *
   * @throws IOException if the open or read causes
   ...
   *
   * @throws IOException if the closing the backing
   ...
   * @throws IOException if there are any exceptions during
   ...
   * @throws IOException if any exception occurs during an
   ...
   * @throws IOException if there is an exception during
